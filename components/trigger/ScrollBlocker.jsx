...
export default function ScrollBlocker() {
  ...
  return (
    ...
    >
      ...
      en page est achevée. Généralement, on utilise un texte en faux latin, le
      ...
      page, le texte définitif venant remplacer le faux-texte dès qu'il est prêt
      ou que la mise en page est achevée. Généralement, on utilise un texte en
      faux latin, le Lorem ipsum ou Lipsum.Le lorem ipsum est, en imprimerie,
      ...
      le texte définitif venant remplacer le faux-texte dès qu'il est prêt ou
      que la mise en page est achevée. Généralement, on utilise un texte en faux
      ...
      une mise en page, le texte définitif venant remplacer le faux-texte dès
